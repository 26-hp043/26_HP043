...
**합계 202개 파일 · 2734 함수 · 3425 수집.** (2026-09-24 실측 — #1625 감사 로그 같은 트랜잭션 · #1629 정박 구간 겹침 직렬화 · #1626 항차 행 잠금 · #1300 해상 경로망·우회 경유지 반영)
...
| 2026-09-24 | `#1849` | **v1.30 — §3.28 「공개 해상 경로망 위의 바닷길」 신설**(`test_sea_route.py` 17함수 · `#1300` E-6) · §4.2에 `AT-SC-005` 우회 경유지 행 · §14 `test_scenario_compare_api.py` 36 → **45함수** · 합계 실측 갱신(200파일·2692함수·3335수집 → **201파일·2718함수·3409수집**). 절 신설이라 버전을 올린다(`AGENTS §4.3`) (#1300) |
