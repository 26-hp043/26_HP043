...
| 2026-09-25 | `#___` | §14 `test_port_calls_mof.py` **신설(10함수)** · 합계 실측 갱신(212파일·2821함수·3529수집 → **213파일·2831함수·3539수집**). 공적 재항 기록 제공자의 첫 구현(해양수산부 선박운항정보 · 09-23 결정)을 **실제 응답 표본**으로 고정한다 — 표본은 임시 브랜치 워크플로로 한 번 받고 브랜치·실행 기록을 지웠다(`#1623`과 같은 방식). 저장·대조·화면은 뒤따르는 단계다 (#1197) |
