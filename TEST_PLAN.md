...
| `test_fleet_reduction.py` | 12 | **§2 단위 · 함대 감축 계획 계산**(`#513` · `PRD §12.3.2`) — ⚠️ **0%면 아무것도 바뀌지 않는가**(완료 기준) · 연료가 **속력의 제곱**으로 주는가 · 추가 항해일 · **연간 등급 관리의 속력 민감도와 같은 연료인가** · 제원 없는 항차를 건너뛰고 세는가 · 50% 상한 · 두 목록 어긋남 거부 · 비용 곱셈 · ⚠️ **단가가 없으면 0이 아니라 빈칸인가** · 감속 안 한 선박은 단가가 없어도 되는가 · 목표 등급(직전 2년 D면 C) |
...
**합계 154개 파일 · 1988 함수 · 2483 수집.** (2026-09-13 실측)
