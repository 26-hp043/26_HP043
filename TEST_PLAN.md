...
**합계 212개 파일 · 2808 함수 · 3516 수집.** (2026-09-25 실측 — #1269 속력 상한 60kn · #1868 FK 잠금 전제 가드 · #1861 트리거 정의 대조 · #1881 시맨틱 색 대조 · #1625 감사 로그 같은 트랜잭션 · #1629 정박 구간 겹침 직렬화 · #1626 항차 행 잠금 · #1300 해상 경로망·우회 경유지 · #1373 트리거 DDL 멱등화 · #1860 교차 잠금 · #1631 활성 키 유니크 인덱스 · #1875 볼륨 가드 · #1868 항차 경로 다섯 × 정박 구간 교차 · #1637 배포 SSH 호스트 키 고정 · #1641 DB 포트 사설 IP 게시 반영)
