...
| 2026-09-26 | `#___` | §14 `test_dashboard_seed.py` 23 → 24 · 합계 실측 갱신(217파일·2862함수·3572수집 → **217파일·2863함수·3573수집**). 공적 기록 대조의 시연 표본(실존 `D7ZY` 부산 출항 12시간 어긋남 한 건)을 시드 수준에서 고정한다 (#1197) |
