...
| 2026-09-26 | `#___` | §14 `test_audit_client_ip.py` **신설(5함수)** · `test_audit_events_db.py` 3 → 4 · 합계 실측 갱신(218파일·2868함수·3579수집 → **219파일·2874함수·3585수집**). 감사 로그·세션 IP가 요청 한도와 같은 판정을 쓰고 소켓 상대를 직접 읽는 자리가 다시 생기지 않게 고정한다 (#1889) |
