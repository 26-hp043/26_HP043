...
| `test_doc_cross_refs.py` | 3 | **§5 인프라 · 문서 정합** — `UIFLOW`·`DESIGN_SYSTEM`을 가리키는 절·화면 참조가 **실재하는지**. `.md`와 `frontend/src` 주석을 함께 훑는다. 버전 드리프트가 아니라 **없는 절을 가리켜 쓴 것**을 잡는다 (`#583`) |
...
**합계 96개 파일 · 1222 함수 · 1501 수집.** (2026-08-21 실측)
