...
| `test_distance.py` | 10 | **§2 단위 · 대권거리** — 날짜변경선(짧은 쪽 1°) · 극(경도 무관 · 극↔극 = πR) · 이종 반구를 **다른 식**(호 길이 · 구면 코사인 법칙)으로 대조 · 자릿수 확정 · `TECH_SPEC §6` 반경 (`#828`) |
...
**합계 133개 파일 · 1761 함수 · 2231 수집.** (2026-09-12 실측)
