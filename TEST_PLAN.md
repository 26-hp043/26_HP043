...
**합계 200개 파일 · 2703 함수 · 3393 수집.** (2026-09-24 실측 — #1625 감사 로그 같은 트랜잭션 · #1629 정박 구간 겹침 직렬화 반영)
