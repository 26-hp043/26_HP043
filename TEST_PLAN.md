...
| 2026-09-25 | `#___` | §14 `test_design_semantic_sync.py` **신설(3함수 · 수집 4)** · 합계 실측 갱신(210파일·2793함수·3491수집 → **211파일·2796함수·3495수집**). `DESIGN_SYSTEM §2.3`의 제약 2 선언·`§4.3`·`§15`가 옛 사본으로 대조돼 있던 것을 현재 값으로 바로잡으며(`#1881`) 표 = 생성 토큰 · 제약 2 실측 · 옛 사본 재출현을 잠근다 (#1881) |
