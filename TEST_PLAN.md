...
| 2026-09-25 | `#___` | §14 `test_health.py` 14 → **17함수**(수집 +5) · 합계 실측 갱신(213파일·2831함수·3539수집 → **213파일·2834함수·3544수집**). 헬스 응답의 `commit`(`#789`) — 떠 있는 커밋을 밖에서 알 수 있게 하고, 배포 확인이 배포한 커밋과 같을 때만 성공으로 친다 (#789) |
