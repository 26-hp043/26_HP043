...
| 2026-09-26 | `#___` | §14 `test_deploy_backend_binding.py` **신설(3함수)** · 합계 실측 갱신(219파일·2875함수·3586수집 → **220파일·2878함수·3589수집**). 백엔드를 루프백에만 게시하고 배포 헬스체크를 터널 주소로 옮기며, 배포마다 공인 `:8001`이 닫혀 있는지 확인하는 단계를 고정한다. `AGENTS §4.3`상 행 추가라 버전은 올리지 않는다 (#786) |
