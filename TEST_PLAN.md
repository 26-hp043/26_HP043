...
| `test_reports_db.py` | 29 | **§4 API · 리포트 데이터 수집** — 진행 중 항차 제외 · 시나리오 인용 · 값 재계산 금지 · **문서 어디에도 UTC ISO가 남지 않는다**(`#646`) · **유종도 원문 코드가 남지 않는다**(`#598` — `#645`가 출처를 고칠 때 같은 표의 옆 칸이 남아 있었다) |
...
**합계 137개 파일 · 1801 함수 · 2274 수집.** (2026-09-12 실측)
