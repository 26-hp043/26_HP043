...
**합계 198개 파일 · 2647 함수 · 3282 수집.** (2026-09-23 실측 — #1779 README 변경 이력 가드 반영)
...
| 2026-09-23 | `#___` | §14 `test_doc_version_sync.py` 3 → **4함수** · 합계 실측 갱신(2646함수·3281수집 → **2647함수·3282수집**). README 문서 구조 표를 고친 PR 일곱이 README 변경 이력에 행을 싣지 않았는데, 기존 검사는 **표의 최종 상태**만 봐서 잡지 못했다. 현재 판본마다 그 문서·판본을 적은 행이 있는지 본다 — 돌연변이(행 삭제) 2종 검출. `AGENTS §4.3`상 행 갱신이라 버전은 올리지 않는다 (#1779) |
