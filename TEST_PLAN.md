...
| 2026-09-25 | `#___` | 변경 이력 `#1849` 행의 `test_scenario_compare_api.py` 서술 **36 → 45를 37 → 46으로 정정**(`#1851`이 먼저 37로 올렸다 · §14 표는 46으로 맞았고 CI는 표만 본다). §14 인벤토리 수치 변화 없음 — `conftest.py`의 워밍 no-op 픽스처는 테스트 함수가 아니다 (#1862) |
