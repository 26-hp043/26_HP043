...
**합계 200개 파일 · 2692 함수 · 3335 수집.** (2026-09-23 실측 — #1671 올해 누적 CII 추이 반영)
...
| 2026-09-24 | `#___` | §1.2 `[ORACLE-C-1b]` 각주의 `PRD §14.2` 응답 예시 인용 `0.98758` → **`0.98757`** + 사유 한 줄. `#1714`(`#1600`)가 비율도 전송 자릿수로 절사하며 PRD 예시를 고쳤는데 이 인용은 옛 값 그대로였다 — 읽는 사람이 존재하지 않는 예시를 근거로 삼는다. 픽스처 값 `0.987579`·등급 `C`는 그대로다. `AGENTS §4.3`상 값 정정이라 버전은 올리지 않는다 (#1809) |
