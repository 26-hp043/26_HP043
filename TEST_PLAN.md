...
| `test_doc_cross_refs.py` | 5 | **§5 인프라 · 문서 정합** — `UIFLOW`·`DESIGN_SYSTEM`을 가리키는 절·화면 참조가 **실재하는지**, 그리고 `AGENTS §4.7` 표기 규칙(화면에 `§`를 붙이지 않는다)을 지키는지. `.md`와 `frontend/src` 주석을 함께 훑는다 (`#583`·`#602`) |
...
**합계 139개 파일 · 1816 함수 · 2289 수집.** (2026-09-12 실측)
