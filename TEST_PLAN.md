...
| `test_case_id_sync.py` | 4 | **§5 인프라 · 문서 정합** — 케이스 ID가 코드·면제 표 어디에도 없는 상태를 막는다 (`§14.5`) |
...
| ID | 대응 이슈 |
|---|---|
| `UT-WX-004` · `IT-WX-001`~`003` | `#62` (기상 fallback 체인 — **경고·신선도 정책이 붙어야 성립한다**) |
| `IT-CSV-002`~`007` | `#59` · `#60` (CSV 내보내기·가져오기) |
| `IT-IMPORT-001`~`005` | `#444` (파라미터 import) |
| `IT-ADOPT-001`~`004` | `#58` (시나리오 채택) |
| `IT-AUDIT-001`~`003` | `#65` (감사 로그) |
| `IT-SOFTDEL-001`~`002` | `#66` (소프트 삭제 통합) |
