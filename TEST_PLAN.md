...
| 2026-09-26 | `#___` | §14 `test_deploy_freeze.py` **신설(5함수 · 6수집)** · 합계 실측 갱신(217파일·2863함수·3573수집 → **218파일·2868함수·3579수집**). 시연 동결(`DEPLOY_FROZEN`)이 push 자동 배포만 건너뛰고 수동 실행은 막지 않는지를 워크플로 파일에서 고정한다 (#789) |
