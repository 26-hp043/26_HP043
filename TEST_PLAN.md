...
| `test_ytd_definition_sync_db.py` | 4 | **§4 API · 정본 정합 · YTD 정의** — 네 경로(실시간 CII · 연도별 이력 · 선대 요약 · 연간 실적 리포트)가 같은 attained CII를 내는가 · 리포트 한 문서 안의 두 행이 일치하는가 · 과거 연도가 진행분에 흔들리지 않는가 (`#750`) |
...
**합계 108개 파일 · 1448 함수 · 1759 수집.** (2026-09-08 실측)
