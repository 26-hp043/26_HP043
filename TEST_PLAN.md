...
| 2026-09-26 | `#___` | §14 `test_port_call_reconcile.py` **신설(7함수)** · `test_data_quality_db.py` 19 → 21 · 합계 실측 갱신(216파일·2851함수·3561수집 → **217파일·2860함수·3570수집**). 공적 기록 대조의 경계(6시간 정각 · 48시간 창 · 대조 불가)와 데이터 점검 다섯째 심각도 `PUBLIC_RECORD`를 고정한다 (#1197) |
