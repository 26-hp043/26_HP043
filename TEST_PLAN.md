...
**합계 199개 파일 · 2662 함수 · 3300 수집.** (2026-09-23 실측 — #1804 선대 요약 목적항 방향 반영)
...
| 2026-09-23 | `#___` | §3.16에 `IT-MAP-006`·`007` · §14 `test_fleet_route_db.py` 5 → **7함수** · 합계 실측 갱신(2660함수·3298수집 → **2662함수·3300수집**). 지도의 방향이 항로 비교의 입사각과 **같은 함수·같은 값**인지를 본다 — 화면이 따로 계산하면 두 화면이 다른 방향을 말할 수 있다 (#1804) |
