...
**합계 187개 파일 · 2490 함수 · 3088 수집.** (2026-09-21 실측 — #1486 `test_tour_gate.py` 14 · `test_tour_login_db.py` 10함수 신설 반영)
