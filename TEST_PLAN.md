...
**합계 166개 파일 · 2267 함수 · 2826 수집.** (2026-09-20 실측 — #1324 `test_doc_cross_refs.py` 코드펜스 가드 1함수 추가 반영)
