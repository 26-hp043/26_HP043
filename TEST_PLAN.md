...
| `test_annual_simulation.py` | 55 | **§2 단위 · 기능③ 시뮬레이터** — seed 재현성 · 확률 누적 · 방향 · `§12.8` 예외 · `parameters_used` 스키마 버전 동결(`#816`) · **거리 지렛대가 강도 차이만 잰다**(`#756` — 혼합비가 아니다) · `PRD §12.6` 다섯 변수 ↔ 구현 지렛대 대응 |
...
**합계 150개 파일 · 1921 함수 · 2399 수집.** (2026-09-13 실측)
