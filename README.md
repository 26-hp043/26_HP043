...
| 2026-09-22 | `#___` | 문서 구조 표의 `DESIGN_SYSTEM.md` 행을 **v2.18**로 갱신 — `§2.5 (b)` 🔒 위험도 단계별 색 · 아이콘 색 확정 |
