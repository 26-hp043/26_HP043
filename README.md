...
| [`AGENTS.md`](./AGENTS.md) | AI 에이전트 작업 규칙 (**v1.6**) — 문서 우선순위(§3.1)·소관 한정 정본(§3.2), Oracle 교차 검증, 규제값 권위 소스, 1 PR = 1 이슈(§7), 「상위 문서」 의미(§4.4), 제품명(§4.5) | ✅ 완료 |
| [`DESIGN_SYSTEM.md`](./DESIGN_SYSTEM.md) | 디자인 토큰 계약서 (**v2.1**, §4.1 단위 표기 capacity 축 파생 #163 + §4.2 물리량 단위 표기 #164) — 컬러·타이포그래피·숫자 포맷·차트 규약·접근성 | ✅ 완료 |
...
| 2026-08-17 | `#463` | 문서 구조 표의 `DESIGN_SYSTEM.md` 행을 v2.1로 갱신 — 대시보드 재설계·UIFLOW v3.0 반영분 (#463) |
