...
| [`TECH_SPEC.md`](./TECH_SPEC.md) | 기술 명세서 (v1.2, Oracle Review + 외부 리뷰 반영) — 이중 정밀도 엔진, PCG64DXSM RNG(canonical vector 고정), capacity 분리(transport/reference), canonical hashing, 스냅샷 격리 | ✅ 완료 |
