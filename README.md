...
| [`docs/DEMO_CHECKLIST.md`](./docs/DEMO_CHECKLIST.md) | 8/8 데모 체크리스트 (#137) — 시연 경로·입력값·기대 표시값. 숫자는 `demoPath.test.ts`가 코드로 고정한다 | ✅ 신규 |
...
| 2026-08-07 | `#137` | 문서 구조 표에 `docs/DEMO_CHECKLIST.md` 행 추가 — 8/8 데모 체크리스트 신설 |
