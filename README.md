...
| 2026-09-23 | `#___` | **변경 이력에서 빠진 일곱 행을 채우고 재발 가드를 둔다** (`#1779`). 문서 구조 표를 고친 PR 일곱(`#1317` · `#1319` · `#1362` · `#1731` · `#1758` · `#1764` · `#1773`)이 이 표에 행을 싣지 않았다. `tests/test_doc_version_sync.py`는 **표의 최종 상태**만 봐서 잡지 못했다 — 표의 현재 판본마다 이 변경 이력에 그 문서·판본을 적은 행이 있는지 보는 검사를 더했다 |
