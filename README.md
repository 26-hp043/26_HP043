...
| [`DESIGN_SYSTEM.md`](./DESIGN_SYSTEM.md) | 디자인 토큰 계약서 (**v2.1**, 등급 3색 체계 · 다크 모드 · 토큰 접두어 `--cii-*` #463) — 컬러·타이포그래피·숫자 포맷·차트 규약·접근성 | ✅ 완료 |
| [`UIFLOW.md`](./UIFLOW.md) | UI Flow 명세서 (**v2.4**, 선대 계층에 함대 감축 계획·데이터 점검 신설 #505) — 화면 목록·계층·흐름·진입 조건 | 🟡 초안 |
