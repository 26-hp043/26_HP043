...
| 2026-09-23 | `#___` | 문서 구조 표의 `DESIGN_SYSTEM.md` 행을 **v2.28**로 — §9.5 「본문 전체를 차지할 때」 · 마커 선수 방향·정박·항구 · 팝오버 신설 (#1821) |
