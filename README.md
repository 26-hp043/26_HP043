...
| 2026-09-23 | `#___` | 「개발 스택」에 **시간대 데이터 — `tzdata`** 소절 (`#1664`). Windows 새 가상환경에서 `Asia/Seoul`이 풀리지 않던 원인(OS 시간대 데이터 없음)과, 운영 Linux 이미지는 OS 데이터를 그대로 쓴다는 점을 적었다 (#1664) |
