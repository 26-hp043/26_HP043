...
| [`DESIGN_SYSTEM.md`](./DESIGN_SYSTEM.md) | 디자인 토큰 계약서 (**v2.27**, 등급 3색 체계 · 다크 모드 · 토큰 접두어 `--cii-*` #463 + `UIFLOW` 참조 정리·신뢰도 배지 표시 임계 #583 + §4.2 일수·속력 자릿수 #592 + §8.2 CII 적용 대상 배지 #653 + §4.2 용량 자릿수 #633 + **rlatnals4114 확정 12건 반영** — §16 미확정 6항목 종결·§0.2 제약 6·§5 〔확정〕/〔제안〕 표기·§12 아이콘 세트·§15 `--brand-*` #747 · #694 + **§8 BrandLogo·§7.2 브랜드 판 반응형 #934** + **rlatnals4114 2026-09-11 확정 반영** — §5 확정/제안 정의·오버레이 규정·§8 슬라이더·§8.3 등급 전이 #930 · #932 · #933 + **§8.4 폼 필드·필드 오류 #936** + **§8.5 어시스턴트 오버레이 「답이 아닌 것」의 표시 #1051** + **§16 항목 4 self-host 마감 #1171** + **§14 비활성 컨트롤의 사유 표기 확정·§16 항목 20 #1170** + **§12 아이콘 규격값의 출처를 Figma로 일원화·§15 `--icon-*` #1174** + **§14 경계와 장식을 가르는 1.4.11 적용 기준 #1202** + **§14 누르면 사유를 내는 버튼 #1415** + **§7.1 외곽 여백 24·산술 정정 · §7.2 사이드바 아이콘 허용 #1450** + **§3 영문 약어 병기의 범위와 예외 #1452** + **§2.5 (b) 위험도 단계별 색·아이콘 색 확정 #1674** + **§14 채움 Primary의 경계를 테두리가 맡는다 #1296** + **§8 텍스트 버튼 높이 확정 #1297** + **§4.4 기준 시각 형식 #1527** + **§8.6 결론 띠 · §8.7 입력-결과 2단 · §5 카드 예산 · §2.3 경고색 한 번 #1690** + **§8.6 위험도 pill의 조건 #1728** + **§14 문서 언어 경계 — 루트는 `ko`, 영문 자리에만 `lang="en"` #1652** + **§7.1 분할하지 않는 화면 · §8.6 감축 계획 보조 하나 #1756** + **§3 `page`(28) 신설 · 본문 15 #1763** + **§8 탭 신설 #1772**) — 컬러·타이포그래피·숫자 포맷·차트 규약·접근성 | ✅ 완료 |
