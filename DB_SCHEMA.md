...
> **[z-factor 출처 확인]** 위 8개 값은 **MEPC.400(83) Table 1**(MEPC.338(76) G3 개정 — 2027~2030 계수 도입, 2025-04-11 채택)에 인쇄되어 있으며 원문과 전건 일치한다. `source_ref`에는 값이 인쇄된 문서를 적는다(§3.2 각주와 같은 기준).
>
