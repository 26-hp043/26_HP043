...
| 2026-09-26 | `#___` | §13.2 `[#1483]` 각주에 **감사 로그·세션 `ip_address`도 같은 판정**(`#1889`) 한 문장 — 종전에는 감사 기록 자리마다 소켓 상대를 직접 적어 클라우드에서 전원 터널 주소였다. `§4.3`상 각주 보강이라 버전은 올리지 않는다 (#1889) |
