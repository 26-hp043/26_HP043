...
| 2026-09-20 | `#1306` | §6.1 `parameters_used` v2 각주 끝에 **스키마 정본이 `TECH_SPEC §5.2.1.2`**임을 적었다 — v2가 이 각주에만 있고 상위 정본 `TECH_SPEC §5.2.1`은 v1 예시뿐이라 우선순위(`AGENTS §3.1`)가 뒤집혀 있었다. 각주 보강이라 `AGENTS §4.3`상 버전은 올리지 않는다 (#1306) |
