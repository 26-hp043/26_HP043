    ...
    "POST /annual-simulations/{id}/reproduce": frozenset(
        {
            ...
            "data.feedback",
            "data.feedback.factor",
            "data.feedback.sample_size",
            "data.feedback.min_sample",
            "data.feedback.requested",
            "data.feedback.applied",
    ...
    "POST /calculations/voyage-cii": frozenset(
        {
            ...
            "data.rating_boundary_cii.superior_boundary",
            "data.rating_boundary_cii.upper_boundary",
