...
> **[EXT-P0-3]** 본 PRD의 fixture 값은 설명용 표시값이다. 자동 테스트의 canonical expected 값은 `TEST_PLAN.md`의 `tests/fixtures/cii/bulk_50000_hfo_2026.json`을 단일 기준으로 한다. 문서 간 정밀도 차이(본 PRD는 10자리, TEST_PLAN은 9자리)는 표시 자릷수 차이이며, TEST_PLAN fixture가 테스트 기준이다.
...
| 2026-07-31 | | 기능① 계산·저장·전환 입력 분리, 처리 로직·검증 규칙(VAL-002·009·010) 정비, 화면 라벨 및 API 예시 정합화 (#132) |
