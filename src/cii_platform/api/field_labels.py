...
_FIELD_LABELS: dict[str, str] = {
    ...
    "display_name": "표시 이름",
    "invite_code": "초대 코드",
    # 둘러보기 링크에 실려 오는 코드 (#1486). 입력칸이 아니라 링크의 일부라
    # 사용자가 직접 치는 이름이 없다 — 화면이 부르는 말(「둘러보기 링크」)을 쓴다.
    "code": "둘러보기 링크",
    "role": "역할",
    "user_id": "계정",
    "token": "메일 링크",
    ...
    "as_of": "기준 시각",
    # 함대 감축 계획 (§2.17 · #513) — 라벨은 화면의 입력칸 이름
    "target": "목표",
    "adjustments": "선박별 감속",
    "adjustments[].vessel_id": "선박",
    "adjustments[].speed_reduction_percent": "감속률",
    "prices": "단가 가정",
    "prices.charter_usd_per_day": "일일 용선료",
    "prices.fuel_usd_per_ton": "연료 단가",
    "plan_name": "계획 이름",
    "plan_id": "감축 계획",
    "year": "연도",
    "from": "시작 연도",
    ...
    # #1923 — 실제 시각의 출처와 「이 값으로 채우기」(`API_SPEC §3.12`) 요청 칸.
    "actual_departure_source": "실제 출항 시각 출처",
    "actual_arrival_source": "실제 도착 시각 출처",
    "started_at_source": "시작 시각 출처",
